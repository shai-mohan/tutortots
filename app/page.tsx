...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 lg:py-32">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-4xl lg:text-6xl font-bold text-dark-blue-gray mb-6 leading-tight">
              Connect with Expert Tutors at <span className="text-orange">Tutortots</span>
            </h1>
            <p className="text-xl text-blue-gray mb-10 leading-relaxed">
      ...
      <section id="features" className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-dark-blue-gray mb-4">Why Choose Tutortots</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="card-clean text-center">
              <CardHeader>
                ...
                <CardTitle className="text-dark-blue-gray">Expert Tutors</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="card-clean text-center">
              <CardHeader>
                ...
                <CardTitle className="text-dark-blue-gray">Flexible Scheduling</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-blue-gray">
            ...
            <Card className="card-clean text-center">
              <CardHeader>
                ...
                <CardTitle className="text-dark-blue-gray">Peer Learning</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-blue-gray">
            ...
            <Card className="card-clean text-center">
              <CardHeader>
                ...
                <CardTitle className="text-dark-blue-gray">Quality Assured</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-blue-gray">
      ...
      {/* Stats Section */}
      <section className="py-20 bg-dark-blue-gray">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-white mb-4">Trusted by Students</h2>
            <p className="text-gray-300 text-lg">Join thousands who have transformed their academic journey</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              <div className="text-4xl font-bold mb-2 text-orange">100+</div>
              <div className="text-gray-300">Qualified Tutors</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold mb-2 text-orange">1000+</div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl font-bold text-dark-blue-gray mb-6">Why Students Choose Tutortots</h2>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-blue-gray">Get help across 50+ subjects with personalized teaching methods.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <Card className="card-clean text-center p-6">
                <BookOpen className="h-8 w-8 text-orange mx-auto mb-3" />
                <div className="text-2xl font-bold text-dark-blue-gray mb-1">50+</div>
                <div className="text-sm text-blue-gray">Subjects</div>
              </Card>

              <Card className="card-clean text-center p-6 mt-8">
                <Star className="h-8 w-8 text-orange mx-auto mb-3" />
                <div className="text-2xl font-bold text-dark-blue-gray mb-1">4.8/5</div>
                <div className="text-sm text-blue-gray">Rating</div>
              </Card>

              <Card className="card-clean text-center p-6 -mt-4">
                <Users className="h-8 w-8 text-orange mx-auto mb-3" />
                <div className="text-2xl font-bold text-dark-blue-gray mb-1">95%</div>
                <div className="text-sm text-blue-gray">Success Rate</div>
              </Card>

              <Card className="card-clean text-center p-6 mt-4">
                <Clock className="h-8 w-8 text-orange mx-auto mb-3" />
                <div className="text-2xl font-bold text-dark-blue-gray mb-1">24/7</div>
                <div className="text-sm text-blue-gray">Access</div>
              </Card>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-4xl font-bold text-dark-blue-gray mb-6">Ready to Start Learning?</h2>
            <p className="text-xl text-blue-gray mb-10">
      ...
      {/* Footer */}
      <footer className="bg-dark-blue-gray text-white py-12">
        <div className="container mx-auto px-4">
