    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 to-amber-100 p-4">
        <Card className="w-full max-w-md border-orange-100 shadow-lg">
          ...
          <CardContent>
            <Link href="/login">
              <Button className="w-full bg-orange-custom hover:bg-orange-600">Go to Login</Button>
            </Link>
          </CardContent>
        </Card>
      </div>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                required
                className="border-gray-300 focus:border-orange-custom focus:ring focus:ring-orange-200 focus:ring-opacity-50"
            ...
            <div className="space-y-2">
              ...
              <Select onValueChange={(value) => setFormData({ ...formData, role: value })}>
                <SelectTrigger className="border-gray-300 focus:border-orange-custom focus:ring focus:ring-orange-200 focus:ring-opacity-50">
                    ...
                    <div className="border border-gray-300 rounded-lg p-4 bg-gray-50">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                          <FileText className="h-8 w-8" style={{ color: "#FFA500" }} />
                          <div>
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                className="text-orange-custom focus:ring-orange-custom"
              />
            ...
            <Button type="submit" className="w-full bg-orange-custom hover:bg-orange-600" disabled={loading}>
          ...
          <div className="mt-6 text-center space-y-2">
            <p className="text-sm text-gray-600">
              ...
              <Link href="/login" className="text-orange-custom hover:text-orange-700 hover:underline">
                Sign in here
              </Link>
            </p>
            <Link href="/" className="text-sm text-gray-500 hover:text-orange-custom hover:underline">
              Back to Home
            </Link>
          </div>
        </CardContent>
